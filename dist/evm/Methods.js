...
export const charge = Method.from({
    ...
    schema: {
        ...
        request: z.pipe(Types.ChargeRequestInputSchema, z.transform(({ amount, chainId, credentialTypes = ['authorization'], currency, decimals, permit2Address, recipient, splits, ...request }) => ({
            ...request,
