...
export declare function evm<const parameters extends evm.Parameters>(parameters: NoExtraKeys<parameters, evm.Parameters>): readonly [import("../../Method.js").Server<{
    readonly name: "evm";
...
}, charge_.Defaults, undefined, {}, string | undefined>];
