...
export type SessionStreamGenerator = AsyncIterable<string> | ((stream: SessionController) => AsyncIterable<string>);
...
export declare function meterIterable(options: MeteredStreamOptions): AsyncGenerator<string>;
//# sourceMappingURL=MeteredStream.d.ts.map