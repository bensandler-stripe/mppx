...
export { deductFromChannel, fromStore, normalizeChannelId, type BackendState, type BaseState, type ChannelStore, type DeductResult, type State, } from '../../session/server/ChannelStore.js';
...
export declare function isContractState(state: SharedChannelStore.State): state is SharedChannelStore.BaseState & LegacyContractBackendState;
